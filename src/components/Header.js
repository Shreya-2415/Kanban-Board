...
function Header({ groupBy, setGroupBy, sortOrder, setSortOrder }) {
  ...
  // Handling changes to the grouping selection and saving the state to localStorage
  ...
  // Handling changes to the sorting selection and saving the state to localStorage
